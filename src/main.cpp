...
uint256 hashGenesisBlock("0x9ebce0e195c310d3227a9a673fceb6e98c06716eec9b8103bda8248cc0f9fb68");
...
static const int64 nTargetSpacing = 60; // testcoin: 2 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc863450e0f684b18ca456d3af8dc24ac0a024999f4f17aac13b6e7e71dc5e7a4");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Europe migrant crisis: Hungary 'will arrest illegal migrants'";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1442165095; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 78283;

        if (fTestNet)
        {
            block.nTime    = 1442001914;
            block.nNonce   = 1898239;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x27e38af42d9a7b7ef24474211ae152451d355d7572a300e222feed99808b1fe0"));
